...
| :---: | :--- | :--- | :--- | :--- |
| **01** | Multi-Account Landing Zone & Core Network Fabric | `terraform-aws-landing-zone-network-fabric` | AWS Organizations Root | TGW ID, Spoke RT, Inbound DNS IPs, IPAM Pools |
| **02** | Hybrid & Multi-Cloud Connectivity | `terraform-aws-hybrid-multicloud-connectivity` | Domain 01 | DXGW ID, Cloud WAN Core ID, BGP ASNs |
| **03** | Centralized Identity, KMS & Security Posture | `terraform-aws-central-identity-kms-security` | Domain 01 | Multi-Region KMS CMK ARNs, OIDC Roles, GuardDuty Master |
...
| **06** | Data Persistence, Streaming & Lakehouse | `terraform-aws-data-persistence-lakehouse` | Domain 01, Domain 03 | RDS Proxy Endpoints, DynamoDB ARNs, MSK Brokers, Iceberg S3 ARNs |
| **07** | Compute & Container Platforms | `terraform-aws-compute-container-platforms` | Domain 01, Domain 03, Domain 04, Domain 06 | EKS API Endpoints, VPC Lattice Service Network ARN |
...
| **10** | AI/ML Inference & Enterprise Guardrails | `terraform-aws-aiml-inference-guardrails` | Domain 01, Domain 03, Domain 06, Domain 07 | Bedrock Guardrail ID, RAG Knowledge Base ID, SageMaker Endpoints |
| **11** | Disaster Recovery & Business Continuity | `terraform-aws-disaster-recovery-resilience` | Domain 01, Domain 03, Domain 06, Domain 07, Domain 09 | Route 53 ARC Control ARNs, Central Backup Vault ARN |
